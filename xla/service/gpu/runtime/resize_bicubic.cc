...
static absl::Status ResizeBicubicImpl(
  ...
  return RunResizeBicubicImpl(se::gpu::AsGpuStreamValue(run_options->stream()),
                              dev_info.threads_per_block_limit, input, output,
...
static absl::Status ResizeBicubicGradImpl(
  ...
  return RunResizeBicubicGradImpl(
      ...
      dev_info.threads_per_block_limit, grad_input, grad_output, align_corners,
      scales_h, scales_w);
}
